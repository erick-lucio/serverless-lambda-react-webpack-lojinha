    ...
    getAllProducts()
      .then((response)=>{
        ...
        response.forEach(element => {
          ...
          dispatchProducts({type: 'ProductSet',product_name:element.product_name,product_price:element.data.price,img_path:"/.netlify/src/assets/imgs/"+element.data.img_name})  
        });
